...
def mypy_test_typed_map():
    ...
    v2: bool = map0["toggle"]
    map0["key0"]  # E: TypedDict "MyMap@31" has no key "key0"
...
def mypy_test_typed_doc():
    ...
    map0 = cast(MyMap, Map())
    doc["map0"] = map0
    doc["map0"] = Array()  # E: Value of "map0" has incompatible type "Array[Never]"; expected "MyMap@63"
    doc["map0"] = Map()  # E: Value of "map0" has incompatible type "Map[Never]"; expected "MyMap@63"
    doc["text0"] = Text()
